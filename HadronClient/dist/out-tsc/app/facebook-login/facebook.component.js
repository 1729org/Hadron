...
var FacebookComponent = (function () {
    function FacebookComponent(facebookService) {
        ...
        this.onBoard = new EventEmitter();
        facebookService.board$.subscribe(function (board) {
            _this.onBoard.emit(board);
        });
    }
...
], FacebookComponent.prototype, "onBoard", void 0);
...
//# sourceMappingURL=C:/Clone/tsc/Hadron/HadronClient/src/app/facebook-login/facebook.component.js.map