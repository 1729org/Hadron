        ...
        FB.login(function (result) {
            FB.api(FacebookConstants.FACEBOOK_API_URL, function (userInfo) {
                return _this.authenticationService
                    ...
                    _this.authentication.next(data);
                }, function (error) {
                    if (error.status === 401) {
                        _this.authentication.next(error.authentication);
                    }
                });
            });
...
//# sourceMappingURL=C:/Old/Hadron/HadronClient/src/app/authentication-zone/facebook-login/facebook.service.js.map